...
{
    #region Sparse File Support for Windows
    public static class FileExtensions
    {
        ...
        static void MarkAsSparseFile(SafeFileHandle fileHandle)
        {
            ...
            if (result == false)
                throw new Win32Exception("Error marking file as sparse.");
        }
        ...
        public static long Megabytes(this int num)
        {
            return 1024 * 1024L * num;
        }
